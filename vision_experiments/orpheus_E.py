...
import numpy as np
from torch_classes.orpheus_E_structured import PrunedCNNLSTMModel
...
model_path = '/Users/chari/autodrive/models/structured_pruned_model.pth'
device = torch.device('cpu')
# device = torch.device('mps' if torch.backends.mps.is_available() else 'cpu')
print(f"Device: {device}")
model = PrunedCNNLSTMModel(seq_length=10)
