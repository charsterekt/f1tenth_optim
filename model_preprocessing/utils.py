...
def preprocess_data_scaled(vehicle):
    ...
    if front_camera_image.shape[:2] != (180, 320):
        ...
        front_camera_image = front_camera_image.resize((320, 180))
...
def add_to_buffer(image_buffer, lidar_buffer, image, lidar, sequence_length):
    """
    Add data to the buffer and manage its length.
    """
...
def prepare_model_for_qat(model):
    """
    Apply the same quantisation conversion to QAT models for loading them correctly
    """
